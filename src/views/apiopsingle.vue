...
export default {
  ...
  methods: {
    ...
    updateStats: function() {
      ...
      this.dbdata['w25'].data.datasets[0].data = utils.replaceZerosWithNulls(pathOr([], ['duration', 'values'], apiOpDetails));
      this.dbdata.touch('w25');

      this.dbdata['w26'].data.labels = utils.bucketsToLabels(pathOr([], ['req_size', 'buckets'], apiOpDetails));
      this.dbdata['w26'].data.datasets[0].data = utils.replaceZerosWithNulls(pathOr([], ['req_size', 'values'], apiOpDetails));
      this.dbdata.touch('w26');

      this.dbdata['w27'].data.labels = utils.bucketsToLabels(pathOr([], ['res_size', 'buckets'], apiOpDetails));
      this.dbdata['w27'].data.datasets[0].data = utils.replaceZerosWithNulls(pathOr([], ['res_size', 'values'], apiOpDetails));
